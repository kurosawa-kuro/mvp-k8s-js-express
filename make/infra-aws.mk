...
# AWSインフラストラクチャ関連のターゲット
.PHONY: aws-deploy aws-destroy aws-plan aws-apply aws-output
.PHONY: aws-validate aws-init aws-workspace aws-state

# デプロイ関連
aws-deploy:
	$(call check-command, aws)
	$(call check-command, terraform)
	terraform init
	terraform plan
